...
public class SpawningFallingHealthBall : MonoBehaviour
{
    ...
    void SpawnTiles()
    {
        ...
        Vector3 fallingHealthBallPosition = new Vector3(GetRandomPositionX(),3,GetRandomPositionZ());
        Debug.Log(fallingHealthBallPosition+ " falling tile position");
        ...
        Instantiate(HealthBall,fallingHealthBallPosition, transform.rotation);
